...
Todos los valores están en [`irpf/params.py`](https://github.com/mimeticflaneur/irpf/blob/main/irpf/params.py)
y [`irpf/inflation.py`](https://github.com/mimeticflaneur/irpf/blob/main/irpf/inflation.py).
Si detectas una discrepancia con el BOE, [abre un issue](https://github.com/mimeticflaneur/irpf/issues/new)
adjuntando la referencia: es la única forma de mantener los datos limpios.

## Bases máximas anuales de cotización

| Año  | Base máxima anual (€) |
|------|-----------------------:|
| 2012 | 39.150,00 |
| 2013 | 41.108,40 |
| 2014 | 43.164,00 |
...
## Cuota de solidaridad (sobre exceso de base)

| Tramo sobre exceso          | 2025  | 2026  |
|-----------------------------|------:|------:|
| Hasta 10% de la base máx.   | 0,92% | 1,15% |
| Del 10% al 50%              | 1,00% | 1,25% |
| Más del 50%                 | 1,17% | 1,46% |

## Escalas IRPF (estatal + autonómica supletoria)
...
| Año       | Umbral inf. | Red. máxima | Umbral sup. | Red. mínima |
|-----------|------------:|------------:|------------:|------------:|
| 2012-2014 | 9.180       | 4.080       | 13.260      | 2.652       |
| 2015-2017 | 11.250      | 3.700       | 14.450      | 0           |
| 2018      | transitorio | —           | —           | —           |
| 2019-2022 | 13.115      | 5.565       | 16.825      | 0           |
...
## IPC anual (diciembre s/ diciembre)
